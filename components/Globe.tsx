...
const focus:Record<string,[number,number,number]>={India:[78.96,20.59,1.65],'United States':[-100,39,1.45],Canada:[-106,57,1.3],'United Kingdom':[-3,55,2.2],Australia:[134,-25,1.5],Germany:[10.4,51.2,2.0],France:[2,46,1.9],Singapore:[103.8,1.35,3.5],Japan:[138,36,1.9],China:[104,35,1.55],Brazil:[-52,-10,1.45],'United Arab Emirates':[54,24,2.6],'Saudi Arabia':[45,24,1.9],'South Africa':[24,-30,1.5]};
